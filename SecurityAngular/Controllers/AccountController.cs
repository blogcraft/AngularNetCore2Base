...
using SecurityAngular.Services;
using System;
...
namespace SecurityAngular.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //        var user = await _userManager.FindByEmailAsync(context.Request.Form["Email"]);
        //        bool rememberMe = false;//context.Request.Form["RememberMe"];

        //        var result = await _signInManager.PasswordSignInAsync(user, context.Request.Form["Password"], rememberMe, lockoutOnFailure: false);
        //        if (result.Succeeded)
        //        {
